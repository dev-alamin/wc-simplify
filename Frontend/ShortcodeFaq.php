...
function melli_faqs_loop_shortcode($atts, $content = null)
{
...
?>
    <div class="melli-faqs">
        <div class="container">
            <div class="row">
                <h1 class="melli-faqs-title">Buy Tiktok Likes easily with Melli</h1>
                <div class="questions">
                    ...
                    <ul>
                        ...
                        if ($the_query->have_posts()) :
                            while ($the_query->have_posts()) :
                                $the_query->the_post(); ?>
                                <li>
                                    <div class="question is-expanded"><svg class="svg-icon svg-icon--boxQuestion" width="51" height="50" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="question__inner">
                                            <h3 class="question__title">Do I need more Instagram likes?</h3>
                                            <div class="question__entry">
                                                <p>Success on all social media platforms depends on reputation and popularity. On Instagram, a high number of IG likes is the most important indicator of both.</p>
                                                <p>A post with ten likes is easy for Instagram users to ignore. But a post with 1,000 likes? That makes them stop for a closer look. It also makes it more likely that they'll check out your Instagram profile and follow your account.</p>
                                                <p>That exposure boosts your Instagram engagement, meaning constant exposure to potential customers or a greater chance of becoming an authentic Insta influencer.</p>
                                                <p>The Instagram algorithm rewards a high amount of likes, so when you purchase Instagram likes, you're not only buying better rankings for your Instagram page. You're also boosting your presence on IG's listings and explore pages. It's the path to success and the ultimate Instagram marketing strategy!</p>
                                            </div><button type="button" class="btn-more question__btn is-active"><span></span> Less</button>
                                        </div>
                                    </div>
                                </li>
                        <?php endwhile;
...
add_shortcode('mellifaqs', 'melli_faqs_loop_shortcode');
